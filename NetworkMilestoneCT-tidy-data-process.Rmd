---
title: "NetworkMilestoneCT-tidy-data-process"
author: "Andrew Llorente"
date: "August 8, 2016"
...
## Creating the data from the scrum pre-read document 

Take the Excel sheet from the network vertical called "SPO NW Daily Scrum Pre Read . xlsx"
Save it as a CSV file, with a filename "scrumpreread<date>", in the path specified in the script below.
Use it as the input file for the R script: networkmilestonect.R



```{networkmilestonect.r}
