milestonect<-function(){
  ...
  pids12<-pids09[which(!pids09$DeliveryNumber %in% itar),]
  ...
  pids15<-mutate(pids14, month_delivered = format(RTEGActualDeliveryDate, "%m"))
  ...
  write.csv(pids28,file = "C:/Users/andrewll/OneDrive - Microsoft/WindowsPowerShell/Data/out/SPO-PRD.csv")
